            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-container shadow-md p-5 bg-white rounded bg-white mt-5 mx-auto" style="max-width:400px">
                        ...
                        <h5 class="text-center mb-3">Trainer sign in</h5>
                        <p class="text-center">Using Trainer account credentials</p>
                        <form action="<%=request.getContextPath() %>/tauthenticate" method="post">
