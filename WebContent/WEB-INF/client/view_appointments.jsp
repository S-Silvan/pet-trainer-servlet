                        ...
                        <div class="container-fluid">
                          ...
                          <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                              ...
                              <li class="nav-item">
                                <a class="nav-link" aria-current="page" href="<%=request.getContextPath() %>/cbook-appointment">Book Appointment</a>
                              </li>
                              <li class="nav-item">
            			...
            			<table class="table table-bordered mt-5">
            				...
            				<tbody>
            					...
            					<tr>
            						...
            						<td><%=booking.getTrainer().getName() %></td>
            						<td><%=booking.getTrainer().getPhoneNumber() %></td>
            						<td><%=booking.getTrainer().getEmail() %></td>
            						<td>
            							<%if(!booking.getStatus().equalsIgnoreCase("completed") && !booking.getStatus().equalsIgnoreCase("cancelled")){ %>
            							<form action="capcancel" method="post">
